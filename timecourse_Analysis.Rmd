...
Create DESeq dataset object with gene-level quants, prefilter out rows with zero
reads
...
# png(file = "/active/allenspach_e/AllenspachRNASeqData/2022_SH2B3_TcellSeq/src/RNAseq/h1eatmap.png", width = 6, height = 6, units = "in", res = 300, type = "cairo")
